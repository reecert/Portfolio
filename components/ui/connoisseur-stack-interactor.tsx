  ...
  return (
    ...
    >
            ...
            {items.map((item, index) => (
              ...
              >
                <div className="flex items-start gap-4 md:gap-6">
                  ...
                  <span className={cn(
                    "text-xl md:text-3xl font-bold transition-all duration-500 mt-2",
                    activeIndex === index 
                      ? "text-sakura scale-110" 
                  ...
                  <div>
                    <h2 className={cn(
                      "text-3xl md:text-5xl font-black uppercase tracking-tighter leading-[0.85] transition-all duration-700",
                      activeIndex === index
                        ? "text-zinc-950 dark:text-white opacity-100 translate-x-4"
                        : "opacity-40 translate-x-0 " +
                          "text-zinc-500 dark:text-transparent " +
                          "dark:[text-stroke:1.0px_#52525b] dark:[-webkit-text-stroke:1.0px_#52525b]"
                    )}>
                    ...
                    {item.description && (
                      <p className={cn(
                        "mt-2 text-sm font-light tracking-wide transition-all duration-500",
                        activeIndex === index
                          ? "text-white/60 opacity-100 translate-x-4"
      ...
      <div className="relative w-full md:w-1/2 flex justify-center items-center mt-12 md:mt-0">
        <div className="absolute w-[120%] h-[120%] bg-sakura/10 blur-[120px] rounded-full transition-opacity duration-1000" />
        
        <svg viewBox="0 0 500 500" className="w-[100%] max-w-[400px] h-auto z-10 drop-shadow-xl dark:drop-shadow-[0_0_60px_rgba(0,0,0,0.8)]">
          <defs>
