...
export function CursorDrivenParticleTypography({
  ...
  useEffect(() => {
    ...
    const init = () => {
      ...
      // Calculate font size based on the widest line
      ...
      const widthRatio = (containerWidth * 0.9) / maxLineWidth;
      const effectiveFontSize = Math.min(fontSize, fontSize * widthRatio);
      ...
      const startY = (containerHeight - totalHeight) / 2 + lineHeight / 2;
