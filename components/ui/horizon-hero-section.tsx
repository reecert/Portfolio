...
export const Component = () => {
  ...
  useEffect(() => {
    ...
    return () => {
      ...
      refs.mountains.forEach((mountain) => {
        ...
        (mountain.material as THREE.MeshBasicMaterial).dispose();
      });
  ...
  const subtitles: Record<number, { line1: string; line2: string }> = {
    0: {
      line1: portfolioData.personal.tagline,
      line2: portfolioData.personal.location
    },
    1: {
      line1: 'Full-Stack systems · CI/CD pipelines',
      line2: 'Cloud-native infrastructure · Scalable APIs'
    },
    2: {
      line1: portfolioData.hero.subheadline.split(',')[0] + ',',
      line2: portfolioData.hero.subheadline.split(',').slice(1).join(',').trim()
    }
  };
      ...
      <div ref={containerRef} className="hero-container cosmos-style">
        ...
        <div className="hero-content cosmos-content">
          ...
          <div ref={subtitleRef} className="hero-subtitle cosmos-subtitle" style={{ visibility: 'hidden' }}>
            <p className="subtitle-line">{portfolioData.personal.tagline}</p>
            <p className="subtitle-line">{portfolioData.personal.location}</p>
          </div>
        </div>
